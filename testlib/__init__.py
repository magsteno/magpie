    split = re.fullmatch('(.*?[^𐑧𐑩𐑫])(𐑩?[𐑛𐑟]|[𐑑𐑕]|𐑼𐑟?|𐑦𐑙𐑟?)$', shav)
...
def shun(tion: str, variant: int) -> Tuple[Union[str, None], int]:
    ...
    tion = [split[0][-1], *(split[1])]
    word = split[0][:-1]
    broken = [[], [], '']
    if len(tion) > 3:
        broken[2] = ['𐑛', '𐑟'][tion[-1] == '𐑟']

    if tion[1] == '𐑯':
        broken[0].append(tion[0])
        broken[0].append(tion[0] + ['𐑯', '𐑙'][tion[2] == '𐑠'])
    else:
        broken[0].append(tion[0] + '𐑤')
        if tion[0] in strokesDict['rhotic']:
            broken[0].append(strokesDict['rhotic'][tion[0]])

    broken[1] = {'𐑖': ['𐑖𐑩𐑯', '𐑐𐑖𐑩𐑯'], '𐑠': ['𐑠𐑩𐑯', '𐑒𐑖𐑩𐑯', '𐑥𐑐𐑖𐑩𐑯'], '𐑗': ['𐑗𐑩𐑯', '𐑕𐑗𐑩𐑯'], '𐑡': ['𐑡𐑩𐑯']}[tion[2]]
    ...
    for pre in broken[0]:
        if output is not None:
            ...
            output = None
            variant -=1
        for cian in broken[1]:
            if word + pre + cian in latin:
                if variant > 0:
                    variant -= 1
                else:
...
def stroke_to_shav(stroke: str) -> str:
    ...
    for i, j in {'𐑘𐑵': '𐑿', '𐑘𐑿': '𐑿', '𐑘𐑘': '𐑘', '𐑾𐑼': '𐑰𐑼'}.items():
...
def steno_to_shav(steno: Tuple[str, ...], standard: bool = False) -> Tuple[Optional[str], int, bool]:
    ...
    for stroke in steno[:-variant or None]:
        ...
        # else, if joiners in output (stroke is a prefix stroke)
            ...
            if any(x == syllable[1] for x in ['𐑛', '𐑟', "'𐑛", "'𐑟"]):
                dz = True
                if syllable[1] == '𐑛':
                    past = True

        # == update previous and commit to output if strokes connect ==
        (previous[0], schwued) = schwu(previous[0], syllable[1] or '')
    ...
    if standard and output is not None:
        ...
        if output[1] in standardise:
            output[1] = standardise[output[1]][bool(variant)]
            if variant:
                variant -= 1
        else:
            split = suffixsplit(output[1])
            if split and split[0] in standardise:
                output[1] = standardise[split[0]][bool(variant)] + split[1]
                if variant:
                    variant -= 1
...
def shav_to_latin(shav: str, variant: int = 0, past: bool = False) -> str:
    ...
    output[1] = [w.replace('^', '') for w in sorted(output[1], key = lambda k: k.endswith('ed'), reverse = past)]
...
def reverse_lookup(word):
    ...
    lookuplist = list(latin.items()) + list(standardise.items())
    for shav, trans in lookuplist:
        if word in trans:
            variant = trans.index(word)
            word = trans
            break

    if not re.fullmatch('^([𐑐-𐑿]+)$', word):
        return []
